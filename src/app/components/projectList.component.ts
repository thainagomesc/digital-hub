...
export class ProjectListComponent {
  ...
  render(projects: Project[]): void {
    ...
    projects
      ...
      .forEach((project) => this.container.appendChild(this.buildCard(project)));
  }

  private buildCard(project: Project): HTMLElement {
    ...
    const focusTitle = createElement("h4", "project-card__focus-title", "Próximos passos do squad");
